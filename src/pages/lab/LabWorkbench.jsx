...
import { Microscope, Search, Droplets, Activity, FileText, CheckCircle, AlertTriangle, Send, X, Clock, User, Loader, Trash2, RefreshCw } from 'lucide-react';
...
export default function LabWorkbench() {
    ...
    const handleFinalize = async () => {
        ...
        setSubmitting(true);
        try {
            // Resolve the integer labid for the lab_reports table (which expects integer, unlike lab_requests which uses UUID)
